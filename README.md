...
How many customers come back after their first transaction, also does that change over time?

A fintech business can acquire thousands of new customers every month. But acquisition alone does not build a sustainable business. The real question is whether those customers stick around. This analysis was built to answer that question: of all the customers who transacted for the first time in a given month, how many returned 1, 2, 3... months later?
...
**Retention drops sharply after month 0.** Across most cohorts, only 19–28% of customers return in month 1. This is the single biggest drop in the entire grid.

**After that initial drop, retention stabilises.** Cohorts from October to December 2024 show consistent activity across months 2–11, holding between 16–27%. Customers who survive past month 1 tend to keep coming back.
...
Month 1 retention has more than doubled between the October 2024 cohort and the August 2025 cohort. The analysis shows that something changed; whether that is product improvements, a different acquisition channel, or a change in customer profile, this is worth investigating further.
...
**1. Investigate the month 1 improvement.** The jump from ~20% to ~46% retention at month 1 across 2025 cohorts is significant. If the business can identify what drove this and replicate it, it would have a direct impact on long-term revenue.

**2. Focus retention effort on the first 30 days.** The data is clear — most churn happens between month 0 and month 1. A targeted re-engagement campaign in the first 30 days after a customer's first transaction would have the highest possible leverage.
